...
const MultipleSelector = React.forwardRef<MultipleSelectorRef, MultipleSelectorProps>(
  (
    ...
    const checkDropdownDirection = () => {
      ...
      const dropdownHeight = commandListRef.current?.offsetHeight || 200;
    ...
    return (
      <Command
        ...
        className={cn(
          'h-auto overflow-visible dark:bg-input/30 shadow-xs transition-[color,box-shadow]',
              ...
              return (
                ...
                >
                  ...
                  <Button
                    variant="ghost"
                    size="icon"
                    className={cn('size-6 rounded-full hover:bg-accent/50', (disabled || option.fixed) && 'hidden')}
                    onKeyDown={(e) => {
                      e.preventDefault();
