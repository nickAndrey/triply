              ...
              <FormControl>
                <div className="w-full flex flex-col items-center text-center">
                  <FormLabel htmlFor="destination">
                    <h2 className="text-2xl font-semibold mb-2">Where does your next adventure begin?</h2>
                  </FormLabel>

                  <p className="text-muted-foreground mb-6">Type a destination you would like to visit.</p>
