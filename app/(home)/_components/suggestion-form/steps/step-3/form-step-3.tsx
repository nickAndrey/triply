        ...
        {form.watch('companions') === 'Friends' && (
          <div className="flex flex-col gap-6">
            <div className="flex flex-col gap-3">
              ...
              <Counter {...counters.groupCounter_friends} />
            </div>
          </div>
        )}
        ...
        {form.watch('companions') === 'Family' && (
          <div className="flex flex-col gap-6">
            <div className="flex flex-col gap-3">
              ...
              <Counter {...counters.groupCounter_adults} />
            </div>

            <div className="flex flex-col gap-3">
              <h4>Children</h4>
              <Counter {...counters.groupCounter_children} />
                ...
                {controls.childrenFormControl.fields.map((field, idx) => (
                  <li key={field.id} className="flex flex-col gap-3">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel htmlFor={`children_${idx}_0`}>Age Group</FormLabel>
                          <FormControl>
                            <RadioGroup
